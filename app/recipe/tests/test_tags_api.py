...
class PublicTagsAPITest(TestCase):
    """Test the public avalaible tags API"""
...
class PirvateTagsAPITest(TestCase):
    ...
    def test_tags_limited_to_user(self):
        """Test that tgas returned for authenticated user"""
    ...
    def test_retrieve_tags_assigned_to_recipes(self):
        """Test filtering tags by those assgned to recipes"""
